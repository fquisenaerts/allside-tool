        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="bg-[#0f0a2e] border-gray-700">
            ...
            <CardFooter className="flex flex-col gap-3">
              {/* Primary option: Stripe Checkout Component */}
              ...
              {/* Fallback option: Direct link */}
              <div className="w-full text-center">
                <a href={stripeLink} className="text-sm text-gray-400 hover:text-white">
          ...
          <Card className="bg-[#0f0a2e] border-gray-700 border-2 border-purple-500">
            ...
            <CardFooter className="flex flex-col gap-3">
              {/* For premium, just use the direct link for simplicity */}
              <div className="w-full">
                <a href={stripeLink} className="w-full">
