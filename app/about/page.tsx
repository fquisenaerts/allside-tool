  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24">
        <div className="bg-[#050314] text-white min-h-screen">
          {/* Hero Section */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative">
                  <Image
                    src="/placeholder.svg?height=400&width=600&query=AI analyzing customer reviews dashboard"
          ...
          <section className="py-16 bg-[#050314]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="relative">
                  <Image
                    src="/placeholder.svg?height=400&width=600&query=AI technology analyzing data with neural networks"
