...
export function Header() {
  ...
  const navigateTo = (path: string) => {
    router.push(getLocalizedUrl(path, language))
    setShowAccountMenu(false)
  }
        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-10">
            {user ? (
              ...
              <>
                <Link
                  href={getLocalizedUrl("/analyze", language)}
                  className="text-base font-medium text-white hover:text-gray-300"
                >
                  {t("header.analyzer")}
                </Link>
                <Link
                  href={getLocalizedUrl("/my-establishments", language)}
                  className="text-base font-medium text-white hover:text-gray-300"
                >
              ...
              <>
                ...
                <Link
                  href={getLocalizedUrl("/contact", language)}
                  className="text-base font-medium text-white hover:text-gray-300"
                >
                  {t("header.contact")}
                </Link>
            ...
            {loading ? (
              ...
              <>
                <Button asChild className="bg-white text-black hover:bg-gray-100 text-base px-5 py-2.5">
                  <Link href={getLocalizedUrl("/signup", language) + "?redirect=payment"}>
                    {t("header.getStarted")}
                  </Link>
                </Button>
                <Link
                  href={getLocalizedUrl("/login", language)}
